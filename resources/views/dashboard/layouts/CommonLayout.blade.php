...
<head>
    ...
    <body class="loading" data-layout-color="light" data-leftbar-theme="dark" data-layout-mode="fluid" data-rightbar-onstart="true">
        ...
        <div class="wrapper">
            <!-- ========== Left Sidebar Start ========== -->
            @include('dashboard/layouts/partials/CommonSidebar')
            <!-- Left Sidebar End -->
            ...
            <div class="content-page">
                <div class="content">
                    <!-- Topbar Start -->
                    @include('dashboard/layouts/partials/CommonTopbar')
                    <!-- end Topbar -->
                ...
                <!-- Footer Start -->
                @include('dashboard/layouts/partials/CommonFooter')
                <!-- end Footer -->
